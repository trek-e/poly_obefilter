...
- **Code-level invariants:** `grep -n "prevFilterType\b\|crossfadeCounter\b" src/HydraQuartetVCF.cpp` — every match must be an array declaration or `[c]` indexed access. Bare scalar access = regression.
