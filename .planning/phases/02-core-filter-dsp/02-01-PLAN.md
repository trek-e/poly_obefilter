...
<task type="auto">
  ...
  <action>
Modify CipherOB.cpp to use SVFilter for audio processing.
...
**Add member variable** to CipherOB struct:
```cpp
SVFilter filter;
```
...
Do NOT implement polyphony yet (Phase 4).
  ...
  <done>CipherOB.cpp includes SVFilter.hpp, has filter member, process() reads cutoff/resonance params, applies CV modulation with attenuverter, and outputs lowpass filtered audio.</done>
</task>
...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <how-to-verify>
    1. Open VCV Rack and add CIPHER · OB module
